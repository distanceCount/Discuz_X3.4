...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1610608294, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1610608294, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1610608294, '1', './data/template/1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
;?>
...
&lt;!&ndash;<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_top'])) echo $_G['setting']['pluginhooks']['global_cpnav_top'];?>&ndash;&gt;
<div class="wp">
<div class="z">
&lt;!&ndash;<?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { ?>&ndash;&gt;
&lt;!&ndash;<?php if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?>&ndash;&gt;<?php echo $nav['code'];?>&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra1'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra1'];?>&ndash;&gt;
</div>
<div class="y">
<a id="switchblind" href="javascript:;" onclick="toggleBlind(this)" title="开启辅助访问" class="switchblind">开启辅助访问</a>
&lt;!&ndash;<?php if(!empty($_G['setting']['pluginhooks']['global_cpnav_extra2'])) echo $_G['setting']['pluginhooks']['global_cpnav_extra2'];?>&ndash;&gt;
&lt;!&ndash;<?php if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { ?>&ndash;&gt;
&lt;!&ndash;<?php if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?>&ndash;&gt;<?php echo $nav['code'];?>&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php if(empty($_G['disabledwidthauto']) && $_G['setting']['switchwidthauto']) { ?>&ndash;&gt;
<a href="javascript:;" id="switchwidth" onclick="widthauto(this)" title="<?php if(widthauto()) { ?>切换到窄版<?php } else { ?>切换到宽版<?php } ?>" class="switchwidth">&lt;!&ndash;<?php if(widthauto()) { ?>&ndash;&gt;切换到窄版&lt;!&ndash;<?php } else { ?>&ndash;&gt;切换到宽版&lt;!&ndash;<?php } ?>&ndash;&gt;</a>
&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?>&ndash;&gt;<a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});">切换风格</a>&lt;!&ndash;<?php } ?>&ndash;&gt;
&lt;!&ndash;<?php if(check_diy_perm($topic)) { ?>&ndash;&gt;
<?php echo $diynav;?>
&lt;!&ndash;<?php } ?>&ndash;&gt;
</div>
</div>
